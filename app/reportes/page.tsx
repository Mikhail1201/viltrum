...
/*
  ...
  COORDINADOR:
  - ve reportes académicos
  - exporta reportes académicos

  DOCENTE:
  - solo ve reportes de asistencias y materias
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 xl:grid-cols-3">
        ...
        <div className="xl:col-span-2">
          <Card>
            ...
            {/* FAKE CHART */}
            <div className="mt-10 flex h-[320px] items-end gap-6">
              {[45, 70, 55, 90, 60, 80, 95].map(
                (height, index) => (
                  <div
                    key={index}
        ...
        <div className="space-y-6">
          <Card>
            ...
            <h2 className="mt-8 text-6xl font-bold text-cyan-600">
              148
            </h2>
          </Card>
          ...
          <Card>
            ...
            <h2 className="mt-8 text-6xl font-bold text-emerald-600">
              92
            </h2>
          </Card>
        </div>
          ...
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Card>
                ...
                <h2 className="mt-4 text-4xl font-bold text-cyan-600">
                  3,942
                </h2>
              </Card>
